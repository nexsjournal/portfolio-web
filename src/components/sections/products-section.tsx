          ...
          {products.map((item) => {
            ...
            return (
              <Link
                ...
                className={`block h-full w-full min-h-[220px] cursor-pointer`}
              >
                <CardContainer className="flex h-full min-h-[220px] w-full !items-stretch !justify-center !py-0 [perspective:1900px]">
                  <CardBody className="group/card relative flex h-full min-h-[220px] w-full flex-col rounded-2xl border border-[rgba(255,255,255,0.04)] bg-white/[0.03] p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] transition-shadow duration-300 [transform-style:preserve-3d] hover:border-[rgba(255,255,255,0.08)] hover:shadow-[0_0_22px_-6px_rgba(31,240,255,0.14),0_24px_80px_-20px_rgba(31,240,255,0.08)]">
                    <div className="flex flex-1 items-start gap-4">
                      {/* Logo 单独更高 translateZ，与文字层差拉开，倾斜时视差更明显 */}
                      <CardItem
                        translateZ={320}
                        className="relative z-20 shrink-0 [transform-style:preserve-3d] will-change-transform"
                      >
                        <div className="relative h-20 w-20 overflow-hidden rounded-2xl bg-zinc-900/90 shadow-[0_22px_56px_-18px_rgba(0,0,0,0.95)] transition-[transform,box-shadow] duration-300 [transform-style:preserve-3d] group-hover/card:shadow-[0_28px_64px_-14px_rgba(31,240,255,0.5)]">
                          <Image
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <CardItem translateZ={34} className="mt-1.5">
